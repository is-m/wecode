...
public interface UserDetailService {
     ...
     */
    UserPrincipal userDetails(String identifier, String secret) throws AuthenticationException;

    /**
     * @param identifier
     * @return
     */
    UserPrincipal findByUid(String identifier) throws AuthenticationException;
