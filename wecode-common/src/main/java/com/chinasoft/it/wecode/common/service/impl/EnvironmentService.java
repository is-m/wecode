...
public class EnvironmentService {
  ...
  private static final String CACHE_NAME = CacheConstants.CACHE_SYS;
  ...
  public Map<String, Serializable> getEnvironment(String uid) {
    if (StringUtils.isEmpty(uid))
      return MapUtils.unmodifyEmptyMap();
    ...
    for (EnvironmentProvider bean : beans) {
      ...
      if (valueWrapper != null) {
        ...
        if (cachedValue != null) {
          ...
          cacheManager.getCache(CACHE_NAME).put(cacheKey, cachedValue);
        } else {
