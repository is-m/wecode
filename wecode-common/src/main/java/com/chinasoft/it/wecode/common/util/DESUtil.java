 ...
 * DES加解密工具类
 * 
 * DES 为对称加密，即用KEY加密后，即可用KEY解密，性能较高，但是安全性较低，如果需要安全性较高的场景推荐使用RSA（非对称加密）
 * 
 * 实践：在跨应用传输数据时，可以使用RSA加密，如果只是存库，可以使用 DES 加密
 * 
 * 详情参考下面链接
 * 
 * https://blog.csdn.net/frankcheng5143/article/details/52078764
 * 
 * @see https://blog.csdn.net/frankcheng5143/article/details/52078764
 */
public class DESUtil {
	 ...
	 * encryption("123", "9911111111119"); System.out.println(a);
	 * System.out.println(decryption(a, "9911111111119")); }
	 */
