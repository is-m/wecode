define(["widget/factory", "jquery", "rt/util", 'ztree', "lib/jquery.ztree.exhide"], function (widget, $, util, tree, exhide) {
    ...
    widget.define("data/tree", {
        ...
        template: "<h1>Hello this tree Widget</h1>",
        ...
        getCheckedNodes: function () {
            return this.ztreeObj.getCheckedNodes().filter(function (item) {
                return !item.isParent || item.check_Child_State == 2
            });
        },
        _initTree: function (data) {
            // https://www.cnblogs.com/yangqianlong/p/8127202.html 模糊搜索
            var self = this;
